...
cost-tier: free
dependencies:
  tools: [shell, file_search]
tags: [adhd, motivation, quick-start]
---
...
Schau dir an:
- {{shell("git status")}} -- gibt es uncommitted changes?
- {{shell("git diff")}} -- was ist offen?
- {{search_files("TODO|FIXME|HACK|XXX", ".")}} -- offene Marker im Code
