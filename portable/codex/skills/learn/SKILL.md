---
name: learn
description: "Nach Vibe-Coding aufbereiten -- jede Kernfunktion erklaeren, Wissen sichern"
argument-hint: "[optional: Fokus-Bereich oder Datei]"
category: meta
cost-tier: free
dependencies:
  tools: [shell, file_read, file_write]
tags: [learning, documentation, post-session]
---
...
- {{shell("git diff")}} oder {{shell("git diff HEAD~1")}} -- was wurde in dieser Session geaendert?
